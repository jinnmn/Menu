    ...
    def handle(self, *args, **kwargs):
        ...
        products = [
            ...
            {'name': "Орехи", 'price': 150.00, 'calories': 600, 'proteins': 20.0, 'fats': 50.0,
             'carbohydrates': 20.0},
            {'name': 'Свекла', 'price': '200.00', 'calories': '150', 'proteins': '2.0', 'fats': '0.1',
             'carbohydrates': '9.6'},
            {'name': 'Капуста свежая', 'price': '90.00', 'calories': '80', 'proteins': '2.0', 'fats': '0.2',
             'carbohydrates': '6.0'},
            {'name': 'Лук репчатый', 'price': '60.00', 'calories': '40', 'proteins': '1.1', 'fats': '0.1',
             'carbohydrates': '9.3'},
            {'name': 'Морковь', 'price': '80.00', 'calories': '60', 'proteins': '1.3', 'fats': '0.2',
             'carbohydrates': '14.0'},
            {'name': 'Говядина отв. п/ф', 'price': '150.00', 'calories': '150', 'proteins': '20.0', 'fats': '7.0',
             'carbohydrates': '0.0'},
            {'name': 'Ветчина в/к', 'price': '70.00', 'calories': '200', 'proteins': '15.0', 'fats': '15.0',
             'carbohydrates': '0.0'},
            {'name': 'Сосиски', 'price': '70.00', 'calories': '250', 'proteins': '12.0', 'fats': '22.0',
             'carbohydrates': '1.0'},
            {'name': 'Петрушка, корень', 'price': '40.00', 'calories': '30', 'proteins': '1.5', 'fats': '0.4',
             'carbohydrates': '5.0'},
            {'name': 'Томат-пюре', 'price': '30.00', 'calories': '30', 'proteins': '1.0', 'fats': '0.1',
             'carbohydrates': '7.0'},
            {'name': 'Сметана', 'price': '50.00', 'calories': '200', 'proteins': '2.8', 'fats': '20.0',
             'carbohydrates': '5.0'},
            {'name': 'Бульон гов. из костей п/ф', 'price': '600.00', 'calories': '50', 'proteins': '8.0', 'fats': '2.0',
             'carbohydrates': '0.5'},
            {'name': 'Соль', 'price': '4.00', 'calories': '0', 'proteins': '0', 'fats': '0', 'carbohydrates': '0'},
            {'name': 'Перец', 'price': '3.00', 'calories': '6', 'proteins': '0.2', 'fats': '0.1',
             'carbohydrates': '1.3'},
            {'name': 'Лавровый лист', 'price': '2.00', 'calories': '4', 'proteins': '0.1', 'fats': '0.1',
             'carbohydrates': '1.0'},
            {'name': 'Уксус 8%', 'price': '5.00', 'calories': '2', 'proteins': '0', 'fats': '0',
             'carbohydrates': '0.5'},
            {'name': 'Сахар', 'price': '70.00', 'calories': '400', 'proteins': '0', 'fats': '0', 'carbohydrates': '100'}
        ]
